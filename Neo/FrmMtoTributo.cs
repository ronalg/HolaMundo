...
namespace Neo
{
    public partial class FrmMtoTributo : Form
    {
        public FrmMtoTributo()
        {
            InitializeComponent();
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    taTributo.Inserta(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, txtNombre.Text.Trim());
                    ConfiguraBoton(true);
                    nombre = txtNombre.Text.Trim();
                }
                else
                {
                    taTributo.Edita(txtNombre.Text.Trim(), Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taTributo.Elimina(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
        ...
        private void FrmMtoTributo_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoTributo = null;
        }
        ...
        private void FrmMtoTributo_Load(object sender, EventArgs e)
        {
