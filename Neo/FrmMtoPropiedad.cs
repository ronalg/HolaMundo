...
namespace Neo
{
    public partial class FrmMtoPropiedad : Form
    {
        public FrmMtoPropiedad()
        {
            InitializeComponent();
        }

        string codigo = null;
        public static string miembro = null;
        ...
        {
            taPropiedad.Fill(dsNeo.tbPropiedad, Utilidad.codigoTrabajo, Utilidad.codigoEmpresa);
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    taPropiedad.Inserta(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, txtCodigo.Text.Trim(), miembro);
                    ConfiguraBoton(true);
                    codigo = txtCodigo.Text.Trim();                    
                }
                else
                {
                    taPropiedad.Edita(txtCodigo.Text.Trim(), Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, miembro, codigo);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taPropiedad.Elimina(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, codigo, miembro);
        ...
        private void FrmMtoPropiedad_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoPropiedad = null;
        }

        private void grdMto_SelectionChanged(object sender, EventArgs e)
        {
            if (grdMto.CurrentRow.Cells["pCodigo"].Value != null)
                codigo = grdMto.CurrentRow.Cells["pCodigo"].Value.ToString();
        }
