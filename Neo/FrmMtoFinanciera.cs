...
namespace Neo
{
    public partial class FrmMtoFinanciera : Form
    {
        public FrmMtoFinanciera()
        {
            InitializeComponent();
        }
        ...
        private void FrmMtoFinanciera_Load(object sender, EventArgs e)
        {
            taTipoFinanciera.Fill(dsNeo.tbTipoFinanciera, Utilidad.codigoTrabajo, Utilidad.codigoEmpresa);
            taFinanciera.Fill(dsNeo.tbFinanciera, Utilidad.codigoTrabajo, Utilidad.codigoEmpresa);
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    taFinanciera.Inserta(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, cboTipo.Text, txtNombre.Text.Trim());
                    ConfiguraBoton(true);
                    tipo = cboTipo.Text;
                ...
                {
                    taFinanciera.Edita(cboTipo.Text, txtNombre.Text.Trim(), Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, tipo, nombre);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taFinanciera.Elimina(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, tipo, nombre);
        ...
        private void FrmMtoFinanciera_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoFinanciera = null;
        }
        ...
        private void grdMto_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                tipo = grdMto.CurrentRow.Cells["fTipo"].Value.ToString();
