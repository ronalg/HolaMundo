...
namespace Neo
{
    public partial class FrmMtoTipoFinanciera : Form
    {
        public FrmMtoTipoFinanciera()
        {
            InitializeComponent();
        }
        ...
        private void FrmMtoTipoFinanciera_Load(object sender, EventArgs e)
        {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    taTipoFinanciera.Inserta(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, txtNombre.Text.Trim());
                    ConfiguraBoton(true);
                    nombre = txtNombre.Text.Trim();
                }
                else
                {
                    taTipoFinanciera.Edita(txtNombre.Text.Trim(), Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taTipoFinanciera.Elimina(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
        ...
        private void FrmMtoTipoFinanciera_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoTipoFinanciera = null;
        }

        private void grdMto_SelectionChanged(object sender, EventArgs e)
        {
            if (grdMto.CurrentRow != null)
                nombre = grdMto.CurrentRow.Cells["tNombre"].Value.ToString();
        }
    }
}
