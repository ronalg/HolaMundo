...
namespace Neo
{
    public partial class FrmMtoTipoCategoria : Form
    {
        public FrmMtoTipoCategoria()
        {
            InitializeComponent();
        }
        ...
        private void FrmMtoTipoCategoria_Load(object sender, EventArgs e)
        {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    taTipoCategoria.Inserta(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, txtNombre.Text.Trim());
                    ConfiguraBoton(true);
                    nombre = txtNombre.Text.Trim();
                }
                else
                {
                    taTipoCategoria.Edita(txtNombre.Text, Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taTipoCategoria.Elimina(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
        ...
        private void FrmMtoTipoCategoria_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoTipoCategoria = null;
        }
