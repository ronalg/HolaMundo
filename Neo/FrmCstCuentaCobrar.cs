    ...
    public partial class FrmCstCuentaCobrar : Form
    {
        ...
        private void btnVerFactura_Click(object sender, EventArgs e)
        {
            if (dsNeo.tbCuentaCobrar.Rows.Count > 0)
            {
                ...
                Utilidad.tscFactura.cboCaja.Text = grdFactura.CurrentRow.Cells["cCaja"].Value.ToString();
                this.Cursor = Cursors.Default;

            }
        }

        private void FrmCstCuentaCobrar_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.cstCuentaCobrar = null;
        }
        ...
        private void FrmCstCuentaCobrar_Load(object sender, EventArgs e)
        {
