...
namespace Neo
{
    public partial class FrmMtoPuesto : Form
    {
        public FrmMtoPuesto()
        {
            InitializeComponent();
        ...
        private void FrmMtoPuesto_Load(object sender, EventArgs e)
        {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    taPuesto.Inserta(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, txtNombre.Text.Trim(), chkVeterinaria.Checked);
                    ConfiguraBoton(true);
                    nombre = txtNombre.Text.Trim();
                }
                else
                {
                    taPuesto.Edita(txtNombre.Text.Trim(), chkVeterinaria.Checked, Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taPuesto.Elimina(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);                        
        ...
        private void FrmMtoPuesto_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoPuesto = null;
        }
