...
namespace Neo
{
    public partial class FrmMtoContacto : Form
    {
        public FrmMtoContacto()
        {
            InitializeComponent();
        }
        ...
        private void FrmMtoContacto_Load(object sender, EventArgs e)
        {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    taContacto.Inserta(short.Parse(lblTrabajo.Text), short.Parse(lblEmpresa.Text), txtNombre.Text.Trim());
                    ConfiguraBoton(true);
                    nombre = txtNombre.Text.Trim();
                }
                else
                {
                    taContacto.Edita(txtNombre.Text.Trim(), short.Parse(lblTrabajo.Text), short.Parse(lblEmpresa.Text), nombre);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taContacto.Elimina(short.Parse(lblTrabajo.Text), short.Parse(lblEmpresa.Text), nombre);
        ...
        private void FrmMtoContacto_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoContacto = null;
        }
