...
namespace Neo
{
    public partial class FrmMtoDepartamento : Form
    {
        public FrmMtoDepartamento()
        {
            InitializeComponent();
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    taDepartamento.Inserta(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, txtNombre.Text.Trim());
                    ConfiguraBoton(true);
                    nombre = txtNombre.Text.Trim();
                }
                else
                {
                    taDepartamento.Edita(txtNombre.Text.Trim(), Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taDepartamento.Elimina(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
        ...
        private void FrmMtoDepartamento_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoDepartamento = null;
        }

        private void grdMto_SelectionChanged(object sender, EventArgs e)
        {
            if (grdMto.CurrentRow != null)
                nombre = grdMto.CurrentRow.Cells["dNombre"].Value.ToString();
        }

        private void FrmMtoDepartamento_Load(object sender, EventArgs e)
        {
