...
namespace Neo
{
    public partial class FrmMtoFormaPago : Form
    {
        public FrmMtoFormaPago()
        {
            InitializeComponent();
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    taFormaPago.Inserta(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, txtNombre.Text.Trim());
                    ConfiguraBoton(true);
                }
                else
                {
                    taFormaPago.Edita(txtNombre.Text.Trim(), Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taFormaPago.Elimina(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, nombre);
        ...
        private void FrmMtoFormaPago_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoFormaPago = null;
        }

        private void grdMto_SelectionChanged(object sender, EventArgs e)
        {
            if (grdMto.CurrentRow != null)
                nombre = grdMto.CurrentRow.Cells["fpNombre"].Value.ToString();
        }

        private void FrmMtoFormaPago_Load(object sender, EventArgs e)
        {
