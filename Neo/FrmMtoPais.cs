...
namespace Neo
{
    public partial class FrmMtoPais : Form
    {
        public FrmMtoPais()
        {
            InitializeComponent();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    taPais.Inserta(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, txtCodigo.Text.Trim(), txtNombre.Text.Trim());
                    ConfiguraBoton(true);
                    codigoPais = txtCodigo.Text.Trim();
                }
                else
                {
                    taPais.Edita(txtCodigo.Text.Trim(), txtNombre.Text.Trim(), Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, codigoPais);
                }
            }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnNuevo.Available && grdMto.CurrentRow != null)
                {
                    ...
                    {
                        taPais.Elimina(Utilidad.codigoTrabajo, Utilidad.codigoEmpresa, codigoPais);
        ...
        private void grdMto_SelectionChanged(object sender, EventArgs e)
        {
            if (grdMto.CurrentRow != null)
                codigoPais = grdMto.CurrentRow.Cells["pCodigo"].Value.ToString();
        }

        private void FrmMtoPais_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utilidad.mtoPais = null;
        }

        private void FrmMtoPais_Load(object sender, EventArgs e)
        {
